...
- **Stopping for futility:** The trial is stopped if some unacceptable level of efficacy is observed. Terminating the trial minimizes the number of patients exposed to a potentially ineffective treatment.
